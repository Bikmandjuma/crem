...
<head>
  ...
  <title>{{ config('app.name', 'Cremohair') }}</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-info navbar-light" style="margin-top:-25px;">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <div data-toggle="dropdown" style="margin-top:5px;cursor:pointer;">{{auth()->guard('admin')->user()->fullname}}</div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="brand-link text-center">
      <span class="brand-text text-white" style="color:white;font-size:25px;"><b>Cremohair</b></span>
    </div>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
            <img src="{{URL::to('/')}}/images/user.png" class="img-circle elevation-2" alt="User Image" style="width:40px;height:40px;border-radius:50%;">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                  <a href="{{route('formproduct')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add Products</p>
                  </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{route('formslider')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add slider</p>
                </a>
              </li>
